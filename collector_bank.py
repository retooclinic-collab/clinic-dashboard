...
OUT_VENDOR = {
 ...
 "세금/공과/수수료":["국세","지방세","세무","부가세","법인세","종소","종합소득세","지방소득세","국고","주민세","재산세","취득세","원천세","공과금","전기","수도","가스","한국전력","한전"],
 ...
 # 에이전시수수료: 환자유치 에이전시 지급수수료(출금). ★ '거래처이체'(주식회사 등)보다 먼저 와야 함(선매칭).
 # - 아이메이(주식회사 아이메이그룹) = 중국(따) 환자유치 에이전시, 출금=해당기간 중국(따)매출 25% 수수료정산 (2026-08-12)
 "에이전시수수료":["아이메이"],
